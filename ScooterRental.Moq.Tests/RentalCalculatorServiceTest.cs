...
namespace ScooterRental.Tests
{
    ...
    public class RentalCalculatorServiceTests
    {
        ...
        public void CalculateRent_InvalidRentEndDate_ErrorMessageExpected()
        {
            ...
            // Act & Assert
            _calculatorService.Invoking(service => service.CalculateRent(rentedScooter))
                .Should().Throw<InvalidRentEndDateException>()
                .WithMessage("Invalid rental end date.");
        }
        ...
        public void CalculateIncome_IncludeActiveRentals_CorrectTotalIncomeExpected()
        {
            ...
            // Act
            var result = _calculatorService.CalculateIncome(specificYear, includeNotCompletedRentals: true);
